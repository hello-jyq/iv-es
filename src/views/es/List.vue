<template>
  <div
    ref="apply"
    class="apply"
    :class="theme == 'Light' ? 'apply-light' : 'apply'"
  >
        ...
        >
          <el-form-item prop="language">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-radio
                  v-model="searchParam.params.language"
                  dict-type-id="ESAnalyzeLanguage"
                  class="light-select"
                  theme="theme"
                />
              </el-col>
          ...
          <el-form-item prop="fuzzySearchDiv">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-radio
                  v-model="searchParam.params.fuzzySearchDiv"
                  dict-type-id="ESFuzzySearch"
                  class="light-select"
                  theme="theme"
                />
              </el-col>
          ...
          <!-- <el-form-item prop="searchWord">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <el-input v-model="searchParam.params.searchWord" clearable />
              </el-col>
            </el-row>
          </el-form-item> -->
          <el-form-item prop="searchWord">
          ...
          <el-form-item prop="searchTarget">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-checkbox
                  v-model="searchParam.params.searchTarget"
                  dict-type-id="ESSearchTarget"
                  class="light-select"
                  theme="theme"
                />
              </el-col>
          ...
          <el-form-item prop="fileNameBoost">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-select
                  v-model="searchParam.params.fileNameBoost"
                  class="input"
                  dict-type-id="ESSearchBoost"
                />
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item prop="fileContentBoost">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-select
                  v-model="searchParam.params.fileContentBoost"
                  class="input"
                  dict-type-id="ESSearchBoost"
                />
              </el-col>
          ...
          <el-form-item prop="fileExtent">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-checkbox
                  v-model="searchParam.params.fileExtent"
          ...
          <el-form-item prop="sortItem">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <dict-radio
                  v-model="searchParam.params.sortItem"
                  dict-type-id="ESSortItem"
                  class="light-select"
                  theme="theme"
                />
              </el-col>
      ...
      <div class="table-bg-box search-list-table">
        <div ref="tables" style="height: 100%">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <p v-html="scope.row.fileContentOutline" />
              </template>
            </el-table-column>
            <el-table-column
              prop="updateTime"
            ...
            >
              <template slot-scope="scope">
                <p class="advice-operation-left">
                  <span
                    class="advice-operation-btn"
                    @click="download(scope.row.fileUrl, scope.row.fileName)"
                  >
...
import { getItems, downloadFile, getTerms } from '@/api/es/es-api'
...
export default {
  ...
  methods: {
    ...
    async preview(fileUrl) {
      ...
      // window.open('http://localhost:8012/onlinePreview?url=' + encodeURIComponent(filepath))
    },
    async fetchData() {
    ...
    async handleEdit(val) {
      ...
      this.$router.push({
        path: '/itm/edit',
        query: { itemId: selectItemId, screenDiv: 'edit' }
      })
    },
    async viewItem(val) {
      this.$router.push({
        path: '/itm/edit',
        query: { itemId: val, screenDiv: 'detail' }
      })
    },
